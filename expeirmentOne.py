# Integrated Script for Training (No Reward) and Test Phase
# Pushkar Singh, 23rd January, 2025
...
participant_id = 456
winsize = [1366,768]
experiment_name = 'Integrated_Experiment'
...
# Colors - Assuming 'red' is frequent, 'green' is infrequent, 'blue' is control
colors = {'frequent': 'red', 'infrequent': 'green', 'control': 'blue'}
...
# Training Phase (No Reward)
training_conditions = [{'color': color} for color in colors.values()] * 10  # Example: 10 trials per color
...
for thisTrial in training_trials:
    ...
    thisExp.addData('phase', 'training_no_reward')
